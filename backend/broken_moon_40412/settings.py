"""
Django settings for broken_moon_40412 project.
...
ROOT_URLCONF = 'broken_moon_40412.urls'
...
WSGI_APPLICATION = 'broken_moon_40412.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_moon_40412 API",
    "DESCRIPTION": "API documentation for broken_moon_40412 App",
    "VERSION": "v1",
}
